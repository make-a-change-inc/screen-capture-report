...
CREATE TABLE IF NOT EXISTS classification_corrections (id TEXT PRIMARY KEY, company_id TEXT NOT NULL REFERENCES companies(id), report_id TEXT NOT NULL REFERENCES reports(id), from_category TEXT NOT NULL, to_category TEXT NOT NULL, minutes REAL NOT NULL, reason TEXT NOT NULL, status TEXT NOT NULL DEFAULT 'applied', created_by TEXT NOT NULL, created_at TEXT NOT NULL, applied_at TEXT NOT NULL);
CREATE TABLE IF NOT EXISTS privacy_request_targets (request_id TEXT PRIMARY KEY REFERENCES privacy_requests(id), company_id TEXT NOT NULL REFERENCES companies(id), target_type TEXT NOT NULL, target_id TEXT NOT NULL);
CREATE TABLE IF NOT EXISTS legal_holds (id TEXT PRIMARY KEY, company_id TEXT NOT NULL REFERENCES companies(id), target_type TEXT NOT NULL, target_id TEXT NOT NULL, reason TEXT NOT NULL, status TEXT NOT NULL DEFAULT 'active', created_by TEXT NOT NULL, created_at TEXT NOT NULL, released_by TEXT, released_at TEXT);
CREATE TABLE IF NOT EXISTS deletion_receipts (id TEXT PRIMARY KEY, company_id TEXT NOT NULL REFERENCES companies(id), request_id TEXT NOT NULL UNIQUE REFERENCES privacy_requests(id), target_type TEXT NOT NULL, target_id_hash TEXT NOT NULL, reports_deleted INTEGER NOT NULL, devices_deleted INTEGER NOT NULL, employees_deleted INTEGER NOT NULL, executed_by TEXT NOT NULL, executed_at TEXT NOT NULL);
CREATE TABLE IF NOT EXISTS delivery_channels (id TEXT PRIMARY KEY, company_id TEXT NOT NULL REFERENCES companies(id), channel TEXT NOT NULL, destination_cipher BLOB NOT NULL, destination_nonce BLOB NOT NULL, destination_hint TEXT NOT NULL, enabled INTEGER NOT NULL DEFAULT 1, created_by TEXT NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL, UNIQUE(company_id, channel));
CREATE TABLE IF NOT EXISTS report_deliveries (id TEXT PRIMARY KEY, company_id TEXT NOT NULL REFERENCES companies(id), report_id TEXT NOT NULL REFERENCES reports(id), channel TEXT NOT NULL, destination_hint TEXT NOT NULL, status TEXT NOT NULL, provider_reference TEXT, error_code TEXT, requested_by TEXT NOT NULL, requested_at TEXT NOT NULL, completed_at TEXT);
CREATE TABLE IF NOT EXISTS delivery_schedules (id TEXT PRIMARY KEY, company_id TEXT NOT NULL REFERENCES companies(id), channel TEXT NOT NULL, weekday INTEGER NOT NULL, hour INTEGER NOT NULL, timezone TEXT NOT NULL, human_review_required INTEGER NOT NULL DEFAULT 1, enabled INTEGER NOT NULL DEFAULT 1, updated_by TEXT NOT NULL, updated_at TEXT NOT NULL, UNIQUE(company_id, channel));
CREATE TABLE IF NOT EXISTS oidc_configs (company_id TEXT PRIMARY KEY REFERENCES companies(id), issuer TEXT NOT NULL, client_id TEXT NOT NULL, client_secret_cipher BLOB NOT NULL, client_secret_nonce BLOB NOT NULL, allowed_domain TEXT, default_role TEXT NOT NULL DEFAULT 'manager', enabled INTEGER NOT NULL DEFAULT 1, updated_by TEXT NOT NULL, updated_at TEXT NOT NULL);
CREATE TABLE IF NOT EXISTS oidc_transactions (state_hash TEXT PRIMARY KEY, company_id TEXT NOT NULL REFERENCES companies(id), verifier_cipher BLOB NOT NULL, verifier_nonce BLOB NOT NULL, nonce_hash TEXT NOT NULL, redirect_uri TEXT NOT NULL, expires_at TEXT NOT NULL);
`;
